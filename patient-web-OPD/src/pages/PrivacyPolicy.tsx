      ...
      <div className="privacy-content-grid">
        ...
        <section className="privacy-card">
          ...
          <div className="privacy-card-body">
            ...
            <ul className="privacy-list">
              <li>
                <strong>Personal Identification Information:</strong> Patient name, mobile number, contact email, date of birth, gender, and residential address.
              </li>
              <li>
                <strong>OPD Appointment Details:</strong> Selected specialist doctor, requested date and time slot, consultation type, and symptoms or reason for visit provided during booking.
              </li>
              <li>
        ...
        <section className="privacy-card">
          ...
          <div className="privacy-card-body">
            ...
            <ul className="privacy-list">
              <li>Booking and confirming your appointment with the assigned doctor and hospital OPD desk.</li>
              ...
              <li>Enabling attending medical specialists to review patient consultation history before the visit.</li>
